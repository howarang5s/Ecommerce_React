...
import { FaShoppingCart, FaBox, FaLaptop, FaGem, FaFemale, FaMale, FaSun, FaMoon, FaUtensils } from 'react-icons/fa'; // Import theme icons
    ...
    <header className={`header-container ${theme}`}>
      ...
      <div className="header-icons">
        ...
        <div 
          ...
          className={`category-icon ${isCategoryActive('food') ? 'active-category' : ''}`} 
          title="Food"
        >
          <FaUtensils /> {/* You may want to use a food-related icon */}
          {isCategoryActive('food') && <div className="active-line"></div>} {/* Line for active category */}
        </div>
